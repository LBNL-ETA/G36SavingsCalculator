...
block RoomVAV3 "Controller for room VAV box"
...
//     "Heating airflow set point (ratio to nominal)";
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput minFloCoo(final unit="1", min=
       0) "Minimum zone airflow in cooling mode" annotation (Placement(
...
equation
  connect(TRooCooSet, conCoo.u_s)
    annotation (Line(points={{-120,40},{-90,40},{-90,0},{-62,0}},
                                                color={0,0,127}));
  connect(TRoo, conHea.u_m) annotation (Line(points={{-120,-40},{-80,-40},{-80,
          -90},{40,-90},{40,-82}},   color={0,0,127}));
  connect(TRooHeaSet, conHea.u_s) annotation (Line(points={{-120,80},{-70,80},{
          -70,-70},{28,-70}},  color={0,0,127}));
  ...
  connect(TRoo, conCoo.u_m) annotation (Line(points={{-120,-40},{-80,-40},{-80,
          -20.6836},{-80,-20},{-50,-20},{-50,-12}},
                                     color={0,0,127}));
  connect(reqFlo.y, yDam)
    annotation (Line(points={{92,0},{110,0}},               color={0,0,127}));

  connect(TRooHeaSet, dTHea.u1) annotation (Line(points={{-120,80},{-70,80},{
          -70,140},{-52,140}},
                           color={0,0,127}));
  connect(dTHea.y, hysWitHol.u)
    annotation (Line(points={{-28,140},{-12,140}}, color={0,0,127}));
  connect(TRoo, dTHea.u2) annotation (Line(points={{-120,-40},{-80,-40},{-80,
          120},{-40,120},{-40,128}},
                                color={0,0,127}));
  ...
  connect(TRooCooSet, dTSet.u1) annotation (Line(points={{-120,40},{-90,40},{
          -90,-120},{-52,-120}},
                       color={0,0,127}));
  connect(TRooHeaSet, dTSet.u2) annotation (Line(points={{-120,80},{-70,80},{
          -70,-140},{-40,-140},{-40,-132}},
                                        color={0,0,127}));
  connect(greThr.y, assMes.u)
    annotation (Line(points={{12,-120},{28,-120}}, color={255,0,255}));
  connect(minFloCoo, swi.u3) annotation (Line(points={{-120,-100},{-20,-100},{
          -20,52},{-12,52}},
                         color={0,0,127}));
  connect(minFloCoo, swi.u1) annotation (Line(points={{-120,-100},{-20,-100},{-20,
