...
block FanVFD "Controller for fan revolution"
  ...
  Modelica.Blocks.Interfaces.RealInput u "Connector of input signal"
    annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=0,
        origin={-120,-24}), iconTransformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-110,0})));
  Modelica.Blocks.Interfaces.RealOutput yFan "fan speed" annotation (Placement(
...
equation
  ...
  connect(u_m, gaiMea.u) annotation (Line(
      points={{10,-120},{10,-92},{-80,-92},{-80,0},{-62,0},{-62,6.66134e-16}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(gaiSet.u, u) annotation (Line(
      points={{-62,30},{-90,30},{-90,-24},{-120,-24}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(swi.u2, uFan) annotation (Line(points={{38,0},{12,0},{12,60},{-120,60}},
        color={255,0,255}));
  connect(swi.y, yFan) annotation (Line(points={{62,0},{110,0}},
        color={0,0,127}));
  annotation (
  defaultComponentName = "conFan",
