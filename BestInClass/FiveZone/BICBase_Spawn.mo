...
model BICBase_Spawn
  ...
  inner Buildings.ThermalZones.EnergyPlus.Building
    ...
    idfName=Modelica.Utilities.Files.loadResource(
        "/home/kun/Documents/bic-savcal36/energyplus/idf/RefBldgMediumOfficeNew2004_Chicago_ModifiedIntensity.idf"),
...
equation
  ...
  connect(dpDisSupFan.p_rel, conFanSup.u_m) annotation (Line(
      points={{311,4.44089e-16},{304,4.44089e-16},{304,-16},{250,-16},{250,-11}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  ...
  connect(conFanSup.u, pSetDuc.y)
    annotation (Line(points={{239,0},{192,0}}, color={0,0,127}));
  ...
  connect(VSupCor_flow.port_b, cor1.ports[1]) annotation (Line(points={{580,140},
          {580,200.9},{578,200.9}}, color={0,127,255}));
  connect(splRetRoo1.port_3, cor1.ports[2]) annotation (Line(points={{640,10},{
          640,192},{582,192},{582,200.9}},
                                       color={0,127,255}));
  connect(VSupSou_flow.port_b, sou1.ports[1]) annotation (Line(points={{760,140},
          {760,170},{760,200.9},{758,200.9}}, color={0,127,255}));
  connect(splRetSou.port_3, sou1.ports[2]) annotation (Line(points={{822,10},{
          820,10},{820,192},{764,192},{764,200.9},{762,200.9}},
                                                            color={0,127,255}));
  connect(VSupEas_flow.port_b, eas1.ports[1]) annotation (Line(points={{940,138},
          {940,200.9},{938,200.9}}, color={0,127,255}));
  connect(splRetEas.port_3, eas1.ports[2]) annotation (Line(points={{1002,10},{
          998,10},{998,190},{942,190},{942,200.9}},
                                                color={0,127,255}));
  connect(VSupNor_flow.port_b, nor1.ports[1]) annotation (Line(points={{1100,
          142},{1100,200.9},{1098,200.9}},
                                      color={0,127,255}));
  connect(splRetNor.port_3, nor1.ports[2]) annotation (Line(points={{1152,10},{
          1152,190},{1102,190},{1102,200.9}},
                                         color={0,127,255}));
  connect(VSupWes_flow.port_b, wes1.ports[1]) annotation (Line(points={{1300,
          138},{1300,170},{1300,200.9},{1298,200.9}},
                                                 color={0,127,255}));
  connect(splRetNor.port_2, wes1.ports[2]) annotation (Line(points={{1162,0},{
          1340,0},{1340,192},{1302,192},{1302,200.9}},
                                                  color={0,127,255}));
