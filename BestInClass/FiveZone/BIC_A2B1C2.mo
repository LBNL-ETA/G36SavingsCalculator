...
equation
  ...
  connect(TSupSetCoo.y, TSetCoo.TCooOn)
    annotation (Line(points={{-179,-214},{-132,-214}}, color={0,0,127}));
  connect(realExpression.y, pSetDuc.u[1]) annotation (Line(points={{101,82},{
          130,82},{130,-7.6},{158,-7.6}}, color={0,0,127}));
  connect(realExpression1.y, pSetDuc.u[2]) annotation (Line(points={{101,66},{
          128,66},{128,-6.8},{158,-6.8}}, color={0,0,127}));
  connect(realExpression2.y, pSetDuc.u[3]) annotation (Line(points={{101,50},{
          128,50},{128,-6},{158,-6}}, color={0,0,127}));
  connect(realExpression3.y, pSetDuc.u[4]) annotation (Line(points={{101,34},{
          128.5,34},{128.5,-5.2},{158,-5.2}}, color={0,0,127}));
  connect(pSetDuc.y, conFanSup.u) annotation (Line(points={{181,-6},{212,-6},{
          212,0},{238,0}}, color={0,0,127}));
  connect(TOut.y, pSetDuc.TOut) annotation (Line(points={{-279,180},{-202,180},
          {-202,2},{158,2}}, color={0,0,127}));
  annotation (
