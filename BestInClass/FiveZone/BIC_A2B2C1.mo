...
model BIC_A2B2C1
  ...
  Controls.DuctStaticPressureSetpoint pSetDuc(
    ...
    annotation (Placement(transformation(extent={{160,-18},{180,2}})));
equation
  ...
  connect(realExpression.y, pSetDuc.u[1]) annotation (Line(points={{101,82},{
          130,82},{130,-9.6},{158,-9.6}}, color={0,0,127}));
  connect(realExpression1.y, pSetDuc.u[2]) annotation (Line(points={{101,66},{
          128,66},{128,-8.8},{158,-8.8}}, color={0,0,127}));
  connect(realExpression2.y, pSetDuc.u[3]) annotation (Line(points={{101,50},{
          128,50},{128,-8},{158,-8}}, color={0,0,127}));
  connect(realExpression3.y, pSetDuc.u[4]) annotation (Line(points={{101,34},{
          128.5,34},{128.5,-7.2},{158,-7.2}}, color={0,0,127}));
  connect(pSetDuc.y, conFanSup.u) annotation (Line(points={{181,-8},{198,-8},{
          198,0},{238,0}}, color={0,0,127}));
  connect(TOut.y, pSetDuc.TOut) annotation (Line(points={{-279,180},{-182,180},
          {-182,0},{158,0}}, color={0,0,127}));
  connect(realExpression4.y, pSetDuc.u[5]) annotation (Line(points={{101,20},{
          126,20},{126,-6.4},{158,-6.4}}, color={0,0,127}));
  annotation (
