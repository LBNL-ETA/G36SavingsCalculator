within BestInClass.FiveZone.BaseClasses;
partial model PartialOpenLoop_spawn
  ...
  // size for reference small commercial building
//   constant Modelica.SIunits.Height hRoo=3.05 "Room height";
//   parameter Modelica.SIunits.Area AFloCor=456.455/hRoo "Floor area corridor";
//   parameter Modelica.SIunits.Area AFloSou=346.023/hRoo "Floor area south";
//   parameter Modelica.SIunits.Area AFloNor=346.023/hRoo "Floor area north";
//   parameter Modelica.SIunits.Area AFloEas=205.265/hRoo "Floor area east";
//   parameter Modelica.SIunits.Area AFloWes=205.265/hRoo "Floor area west";
//
//   parameter Modelica.SIunits.Volume VRooCor=AFloCor*hRoo "Room volume corridor";
//   parameter Modelica.SIunits.Volume VRooSou=AFloSou*hRoo "Room volume south";
//   parameter Modelica.SIunits.Volume VRooNor=AFloNor*hRoo "Room volume north";
//   parameter Modelica.SIunits.Volume VRooEas=AFloEas*hRoo "Room volume east";
//   parameter Modelica.SIunits.Volume VRooWes=AFloWes*hRoo "Room volume west";

  // size for reference medium commercial building
  parameter Modelica.SIunits.Area AFloCor=2698/hRoo "Floor area corridor";
  parameter Modelica.SIunits.Area AFloSou=568.77/hRoo "Floor area south";
  parameter Modelica.SIunits.Area AFloNor=568.77/hRoo "Floor area north";
  parameter Modelica.SIunits.Area AFloEas=360.0785/hRoo "Floor area east";
  parameter Modelica.SIunits.Area AFloWes=360.0785/hRoo "Floor area west";
