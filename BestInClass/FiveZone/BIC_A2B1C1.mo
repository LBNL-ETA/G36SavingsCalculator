...
equation
  ...
  connect(occSch.occupied, controlBus.occupied) annotation (Line(
      ...
      index=1,
      extent={{6,3},{6,3}}));
  connect(pSetDuc.TOut, TOut.y) annotation (Line(points={{158,8},{-188,8},{-188,
