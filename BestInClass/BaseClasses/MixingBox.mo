...
model MixingBox "Outside air mixing box with non-interlocked air dampers"
  ...
  Buildings.Fluid.Actuators.Dampers.VAVBoxExponential damOut(
  ...
  Buildings.Fluid.Actuators.Dampers.VAVBoxExponential damExh(
    redeclare package Medium = Medium,
  ...
  Buildings.Fluid.Actuators.Dampers.VAVBoxExponential damRet(
    redeclare package Medium = Medium,
    ...
    final riseTime=riseTime,
    final init=init,
    y_start=y_start) "Return air damper" annotation (Placement(transformation(
        origin={80,0},
        extent={{-10,-10},{10,10}},
        rotation=90)));
