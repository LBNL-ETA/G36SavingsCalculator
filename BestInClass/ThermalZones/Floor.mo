...
equation
  ...
  connect(senRelPre.p_rel, p_rel) annotation (Line(
      ...
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(gainSchedule.yGaiNor, nor.qGai_flow) annotation (Line(points={{-59,106},
          {-20,106},{-20,144},{142.4,144}}, color={0,0,127}));
  connect(gainSchedule.yGaiWes, wes.qGai_flow) annotation (Line(points={{-59,102},
          {-20,102},{-20,64},{10.4,64}}, color={0,0,127}));
  connect(gainSchedule.yGaiSou, sou.qGai_flow) annotation (Line(points={{-59,114},
          {-46,114},{-46,-26},{124,-26},{124,-16},{142.4,-16}}, color={0,0,127}));
  connect(gainSchedule.yGaiCor, cor.qGai_flow) annotation (Line(points={{-59,118},
          {136,118},{136,64},{142.4,64}}, color={0,0,127}));
  connect(gainSchedule.yGaiEas, eas.qGai_flow) annotation (Line(points={{-59,110},
          {292,110},{292,84},{302.4,84}}, color={0,0,127}));
